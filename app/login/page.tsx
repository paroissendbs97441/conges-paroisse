...
export default function LoginPage() {
  ...
  return (
    <div style={card}>
      <h1 style={{ fontSize: 22 }}>Espace congés – Paroisse</h1>
...
const card: React.CSSProperties = {
  maxWidth: 380, margin: "80px auto", background: "#fff", padding: 28,
  borderRadius: 12, boxShadow: "0 1px 4px rgba(0,0,0,.1)",
};
...
const btn: React.CSSProperties = {
  ...
  border: "none", borderRadius: 6, cursor: "pointer", fontSize: 15, marginTop: 6,
};
